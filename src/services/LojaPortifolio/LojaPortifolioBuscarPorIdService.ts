...
export const LojaPortifolioBuscaPorIdService = async (id: number): Promise<LojaPortifolioItem | null> => {
    try {
        ...
        const response = await axios.get(`${API_BASE_AGENDA_URL}LojaPortifolio/${id}`, config);
