...
export const LojaPortifolioPaginadoService = async (paginacao: PaginacaoItens<LojaPortifolioItem>): 
Promise<PaginacaoItens<LojaPortifolioItem> | null> => {
    try {
        ...
        const response = await axios.post(`${API_BASE_AGENDA_URL}LojaPortifolio/BuscarPaginado`, paginacao, config);
