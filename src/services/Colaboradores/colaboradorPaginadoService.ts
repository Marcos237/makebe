...
export const ColaboradorPaginadoService = async (paginacao: PaginacaoItens<ColaboradorItens>): Promise<PaginacaoItens<ColaboradorItens> | null> => {
    try {
        ...
        const response = await axios.post(`${API_BASE_AGENDA_URL}Colaborador/BuscarPaginado`, paginacao, config);
