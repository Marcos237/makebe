...
export const BuscarColaboradorPorIdService = async (id: number): Promise<ColaboradorItens | null> => {
    try {
        ...
        const response = await axios.get(`${API_BASE_AGENDA_URL}Colaborador/${id}`, config);
