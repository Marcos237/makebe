...
import PortifolioBusca from "./PortifolioSearch"
...
import PortifolioPersistir from './PortifolioForm';
            ...
            <div className={styles.pageContent}>
                <div className={`persistir ${styles.section}`}>
                    ...
                    <div className={styles.sectionBody}>
                        <PortifolioPersistir
                            persistirProps={{ item: portifolioitem, onSave: handleSaveSuccess }}
                ...
                <div className={`lista ${styles.section}`}>
                    ...
                    <div className={styles.sectionBody}>
                        <div className={styles.listHeader}>
                            <h2>Lista</h2>
                            <p>Visualize e gerencie os portifólios cadastrados</p>
                        </div>
